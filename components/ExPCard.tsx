  ...
  return (
    ...
    <div className='exp-card group '>
        ...
        <div className='relative w-full h-40 my-3 object-contain'>
                <Image src="/new.png" alt="" fill  priority className='object-contain'/>
        </div>
    ...
    <div className='exp-card group '>
        ...
        <div className='relative w-full h-40 my-3 object-contain'>
                <Image src="/next.png" alt="" fill  priority className='object-contain'/>
        </div>
        <div className='relative flex w-full mt-2'>
            <div className='car-card__btn-container' >
                 <CustomButton  title='view more' handleClick={() => setIsOpen(true)} rightIcon="/right-arrow.svg" textStyles='text-white text-[14px] leading-[17px] font-bold' containerStyles='w-full py-[16px] rounded-full bg-primary-blue'/>
    ...
    <div className='exp-card group '>
        ...
        <div className='relative w-full h-40 my-3 object-contain'>
                <Image src="/php.png" alt="" fill  priority className='object-contain'/>
        </div>
        <div className='relative flex w-full mt-2'>
            <div className='car-card__btn-container' >
                 <CustomButton  title='view more' handleClick={() => setIsOpen(true)} rightIcon="/right-arrow.svg" textStyles='text-white text-[14px] leading-[17px] font-bold' containerStyles='w-full py-[16px] rounded-full bg-primary-blue'/>
    ...
    <div className='exp-card group '>
        ...
        <div className='relative w-full h-40 my-3 object-contain'>
                <Image src="/Laravel.png" alt="" fill  priority className='object-contain'/>
        </div>
        <div className='relative flex w-full mt-2'>
            <div className='car-card__btn-container' >
                 <CustomButton  title='view more' handleClick={() => setIsOpen(true)} rightIcon="/right-arrow.svg" textStyles='text-white text-[14px] leading-[17px] font-bold' containerStyles='w-full py-[16px] rounded-full bg-primary-blue'/>
    ...
    <div className='exp-card group '>
        ...
        <div className='relative w-full h-40 my-3 object-contain'>
                <Image src="/js.png" alt="" fill  priority className='object-contain'/>
        </div>
        <div className='relative flex w-full mt-2'>
            <div className='car-card__btn-container' >
                 <CustomButton  title='view more' handleClick={() => setIsOpen(true)} rightIcon="/right-arrow.svg" textStyles='text-white text-[14px] leading-[17px] font-bold' containerStyles='w-full py-[16px] rounded-full bg-primary-blue'/>
